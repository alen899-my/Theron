<template>
  <div class="relative min-h-screen bg-background text-foreground flex flex-col justify-between">
    <!-- Header -->
    <header class="flex items-center justify-between px-6 py-5 border-b border-border">
